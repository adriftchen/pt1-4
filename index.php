													...
													<div class="mainmu">
														...
														<div class="mw" style="dislpay:none;position:relative;top:-5px;z-index:80;width:150px;margin-left:100px">
															...
															if($Menu->count(['parent'=>$main['id']])>0){
																...
																foreach($subs as $sub){
																?>
																<a href="<?=$sub['href'];?>"><div class="mainmu2"><?=$sub['text'];?></div></a>
																<?php
																}
															}
															?>
...
?>
                	...
                	<div style="width:89%; height:480px;" class="dbor">
						...
						<div class="cent" style="margin:5px 0" onclick="pp(1)"><img src="icon/up.jpg" alt=""></div>
						<?php
						$imgs=$Image->all(['sh'=>1]);
						foreach($imgs as $key => $img){
						echo "<div class='cent im' id='ssaa$key'><img src='img/{$img['img']}'></div>";
						}
						?>
						<div class="cent" style="margin:5px 0" onclick="pp(2)"><img src="icon/dn.jpg" alt=""></div>
						                        <script>
                        	var nowpage=0,num=0;
							function pp(x)
							{
